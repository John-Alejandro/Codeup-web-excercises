...
$.ajax("https://hookb.in/K3xBq06YBDtPMK88MK60").done(function(data){
    console.log(data);
})
...
// );$.ajax("https://www.themealdb.com/api.php").done(function(data) {
//     console.log(data)
// }
//do something with data here})
// $.ajax("https://www.amctheatres.com/api.php").done(function(data) {
//     console.log(data)
// });
